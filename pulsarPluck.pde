...
void setup() {
  ...
  guy.resize(0,50);
  gbt = loadImage("gbt.jpg");
  gbt.resize(0,200);
  arecibo = loadImage("arecibo.jpg");
  arecibo.resize(0,200);
...
void startScreen() { 
  ...
  if(question == 1){
    ...
    if (g == 0){
      ...
      fill(110, 150, 250); 
      textSize(30);
      text("On your way!", 100,100); 
      textSize(20);
      text("Question 4, Which is the Green Bank Telescope?", 100,140);
      image(gbt,200,500);
      image(arecibo,600,500);
      image(space,200,300); 
    }
     if (mouseX > 60 && mouseX < 323 && mouseY > 411 && mouseY < 598 && mousePressed == true){
      question = 5;
      f = 0; 
      g = 0;
    }
    ...
    if (g == 0){
      ...
      fill(110, 150, 250); 
      textSize(30);
      text("yesssss!", 100,100); 
      textSize(20);
      text("Question 5, Which graph has 'snake bites' indicating RFI?", 100,140);
      image(snake,600,400);
      image(noise,200,400); 
    }
     if (mouseX > 430 && mouseX < 750 && mouseY > 300 && mouseY < 700 && mousePressed == true){
      question = 6;
      f = 0; 
      g = 0;
    }
    ...
    if (g == 0){
      ...
      text("On your way!", 100,100); 
      textSize(20);
      text("Question 6, Which graph is noise, indicating there is no strong signal?", 100,140);
      image(snake,600,500);
      image(noise,200,500); 
    }
     if (mouseX > 30 && mouseX < 270 && mouseY > 300 && mouseY < 640 && mousePressed == true){
      question = 7;
      f = 0; 
      g = 0;
    }
    ...
    if (g == 0){
      ...
      text("Oink!", 100,100); 
      textSize(20);
      text("Question 7, Which graph tells the chi squared?", 100,140);
      image(chi,700,500);
      image(snake,250,500); 
    }
     if (mouseX > 500 && mouseX < 900 && mouseY > 400 && mouseY < 620 && mousePressed == true){
      question = 8;
      f = 0; 
      g = 0;
    }
